...
__is_atom = lambda token : (token.token_type == Token_Type.int or token.token_type == Token_Type.float or
    ...
    or token.token_type == Token_Type.orbit or token.token_type == Token_Type.satellite or token.token_type == Token_Type.space_debris or token.token_type == Token_Type.agent)
