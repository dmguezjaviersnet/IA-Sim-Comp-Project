...
show_orbits_keyword =  Terminal('show_orbits')
...
show_orbits_stmt =  Non_terminal('show_orbits_stmt', 'ast')
...
p10 = Production (func_body_stmt,
                ...
                [start_stmt], [stop_stmt], [pause_stmt], [drawquadtree_stmt], [animate_earth_stmt], [show_orbits_stmt]],
...
p48 = Production(show_orbits_stmt,
                [[show_orbits_keyword]],
                [[(show_orbits_stmt_rule, True)]]
                )
...
orbsim_token_string: Dict[Token_Type, str] = {
    ...
    Token_Type.show_orbits : 'show_orbits',
